...
## BioRxiv and MedRxiv 
Literature search in biorxiv and medrxiv was done with the R by downloading the data from the dedicated [COVID-19 SARS-CoV-2 preprints page](https://connect.biorxiv.org/relate/content/181) in json format, and can be found on [Github](https://github.com/rmvpaeme/PIMS_TS/blob/master/preprint_search.R).
...
![](./plots/PRISMA 2009 flow diagram.png)
...
```{r}
df_singlecases <-
  read_excel("/Users/rmvpaeme/Onedrive/UGent/PIMS-TS Systematic Review - General/Data extractie/data extractie.xlsx",
             sheet = "Single cases",
             skip = 1,
...
#datatable(assoc_outcome_full %>% select(contains("patient") | contains("casedef") | contains("unfavourable_course") | contains("mild_pres")))
...
#datatable(assoc_outcome_full %>% select(contains("patient") | contains("casedef") | contains("PICU_candidate") | contains("mild_pres")))
